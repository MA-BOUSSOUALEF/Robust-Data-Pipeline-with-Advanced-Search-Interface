    ...
    function afficherPage() {
      ...
      competencesAffichees.forEach(async competence => {
          ...
          const detailsElement = document.createElement("details");
            ...
            <span class="bg-white p-2 border rounded">${competence.ct_url.replace("#", '') || "Néant"}</span>
            </div>
            <br/>
            ...
            <span class="bg-white p-2 border rounded">${competence.ct_plateau || "Néant"}</span>
            </div>
            ...
            <span class="bg-white p-2 border rounded">${competence.ct_ss_domaine || "Néant"}</span>
            </div>
          </fieldset>
            `;
