  ...
  pageItems.forEach((item, index) => {
    ...
    lineDiv.innerHTML = `
      <div>
        ...
        –
        <a href="http://127.0.0.1:5500/fiche.html?code=${struct_num}" target="_blank" class="text-blue-600 underline">Voir la fiche ${acrStruct}</a>
        –
        <a href="http://127.0.0.1:5500/panorama.html?code=${struct_num}" target="_blank" class="text-blue-600 underline">Voir le panorama scientifique ${acrStruct}</a>
      </div>
